...
Subject.create!(:name => "TOC" , :branch_semester_id => "5")
Subject.create!(:name => "OS" , :branch_semester_id => "5")
Subject.create!(:name => "JAVA", :branch_semester_id => "4")
Subject.create!(:name => "OR", :branch_semester_id => "5")
Subject.create!(:name => "SE", :branch_semester_id => "3")
Subject.create!(:name => "DBMS", :branch_semester_id => "5")
Subject.create!(:name => "OOPS", :branch_semester_id => "3")
Subject.create!(:name => "CPP", :branch_semester_id => "1")
Subject.create!(:name => "MT", :branch_semester_id => "4")
Subject.create!(:name => "DEL", :branch_semester_id => "3")
Subject.create!(:name => "BME" , :branch_semester_id => "1")
Subject.create!(:name => "EMech" , :branch_semester_id => "2")
