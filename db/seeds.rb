...
#Professor.create!( :name => "Pooja Kamath" , :age => "34" , :gender => "Female")
...
#Room.create!(:name => "F7")
#Room.create!(:name => "F8")
#Room.create!(:name => "F9")Room.create!(:name => "F10")Room.create!(:name => "F11")Room.create!(:name => "F12")Room.create!(:name => "F13")Room.create!(:name => "F14")
#Room.create!(:name => "F15")Room.create!(:name => "F16")Room.create!(:name => "S1")Room.create!(:name => "S2")Room.create!(:name => "S3")Room.create!(:name => "S4")Room.create!(:name => "S5")Room.create!(:name => "S6")Room.create!(:name => "S7")Room.create!(:name => "S8")Room.create!(:name => "S9")Room.create!(:name => "S10")Room.create!(:name => "S11")Room.create!(:name => "S12")Room.create!(:name => "S13")Room.create!(:name => "S14")Room.create!(:name => "S15")Room.create!(:name => "S16")
