...
$(document).ready(function() 
{
    ...
    $('#calendar').fullCalendar({
       ...
       eventRender: function(event, element)
        {    
            element.find('.fc-time', this ).append("<span id='close'><img src='http://desxcloud.com/daniel/img/delete-icon.gif' width='15px' height='15px' id='close'/></span>");
            hideIcon(event,element);
        ...
        eventClick: function(event, jsEvent, view)
        {
             ...
             i = 0;
            // alert("before span" + i)
             $("span#close", this).on("click" , function()
             {
            //     alert("del event");
                i = i + 1;
    ...
    var hideIcon = function(event,element)
    {
        $('#close', this).hide();
    };
